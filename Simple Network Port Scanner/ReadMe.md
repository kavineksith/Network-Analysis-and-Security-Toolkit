...
A high-performance, asynchronous port scanner written in Python. Designed for developers, network engineers, and cybersecurity professionals, this tool offers fast, flexible, and reliable scanning of TCP ports across a given range, with support for:

* ✅ **Asynchronous Scanning** for blazing speed
* 🚀 **Generator-based iteration** for minimal memory footprint
* 🛠️ **Custom Exceptions & Dunder Methods** for robustness and pythonic integration
