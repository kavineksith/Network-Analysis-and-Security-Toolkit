...
- **High performance**: Asynchronous architecture (asyncio) for blazing fast scans
- **Memory Optimized**: Generator-based iteration for IP/Port ranges
- **Robustness**: Custom exceptions and Dunder methods for pythonic usage
